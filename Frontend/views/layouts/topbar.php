    <header class="top-bar">
      <div class="logo-area" style="margin:0;">
        <div class="logo-icon"
          ...
          <img src="assets/images/logo.png" alt="Logo" style="width: 20px; height: 20px; object-fit: contain;">
        </div>
        <div class="logo-text">Pudheera Retail <span
            style="font-size: 0.8rem; color:var(--muted); font-family:var(--font-body)">v1.0</span></div>
      </div>
      <div class="user-menu">
        <span style="font-weight: 500; color: var(--text-strong);">Main Counter</span>
